export const translations = {
  en: {
    appName: "Oman Auto Text Art Mart",
    home: "Home",
    addCar: "Add Car",
    carsList: "Cars List",
    ...
    listingMessage: "List your car on Oman Auto Text Art Mart and reach thousands of potential buyers!",
  ...
  ar: {
    appName: "سوق عُمان لفن نص السيارات",
    home: "الرئيسية",
    addCar: "إضافة سيارة",
    ...
    listingMessage: "أضف سيارتك في سوق عُمان لفن نص السيارات وصل إلى آلاف المشترين المحتملين!",
    ...
    tooManyPhotos: "عدد الصور كثير جدا",
